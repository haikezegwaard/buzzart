...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'monitor_project', 'template',
                      self.gf('django.db.models.fields.FilePathField')(max_length=100, path='/home/hz/projects/buzzart/dashboard/templates', null=True, recursive=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.template'
        db.delete_column(u'monitor_project', 'template')
    ...
    models = {
        ...
        u'monitor.project': {
            ...
            'template': ('django.db.models.fields.FilePathField', [], {'max_length': '100', 'path': "'/home/hz/projects/buzzart/dashboard/templates'", 'null': 'True', 'recursive': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.template'
        db.alter_column(u'monitor_project', 'template', self.gf('django.db.models.fields.FilePathField')(path='/home/hz/projects/buzzart/dashboard/templates', max_length=100, null=True, recursive=True))

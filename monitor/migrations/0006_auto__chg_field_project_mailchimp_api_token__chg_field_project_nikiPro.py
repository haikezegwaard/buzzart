...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.mailchimp_api_token'
        db.alter_column(u'monitor_project', 'mailchimp_api_token', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Project.nikiProject'
        db.alter_column(u'monitor_project', 'nikiProject', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Project.mailchimp_list_id'
        db.alter_column(u'monitor_project', 'mailchimp_list_id', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Project.fanpage_id'
        db.alter_column(u'monitor_project', 'fanpage_id', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

        # Changing field 'Project.fanpage_token'
        db.alter_column(u'monitor_project', 'fanpage_token', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'Project.mailchimp_api_token'
        db.alter_column(u'monitor_project', 'mailchimp_api_token', self.gf('django.db.models.fields.CharField')(default=0, max_length=1000))

        # Changing field 'Project.nikiProject'
        db.alter_column(u'monitor_project', 'nikiProject', self.gf('django.db.models.fields.CharField')(default=0, max_length=1000))

        # Changing field 'Project.mailchimp_list_id'
        db.alter_column(u'monitor_project', 'mailchimp_list_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=1000))

        # Changing field 'Project.fanpage_id'
        db.alter_column(u'monitor_project', 'fanpage_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=1000))

        # Changing field 'Project.fanpage_token'
        db.alter_column(u'monitor_project', 'fanpage_token', self.gf('django.db.models.fields.CharField')(default=0, max_length=1000))

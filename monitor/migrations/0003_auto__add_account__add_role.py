...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'monitor_account', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
        ))
        db.send_create_signal(u'monitor', ['Account'])

        # Adding model 'Role'
        db.create_table(u'monitor_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('account', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['monitor.Account'], unique=True)),
            ('role', self.gf('django.db.models.fields.CharField')(default='owner', max_length=512)),
        ))
        db.send_create_signal(u'monitor', ['Role'])


    def backwards(self, orm):
        # Deleting model 'Account'
        db.delete_table(u'monitor_account')

        # Deleting model 'Role'
        db.delete_table(u'monitor_role')
    ...
    models = {
        ...
        u'monitor.account': {
            ...
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'accounts'", 'blank': 'True', 'through': u"orm['monitor.Role']", 'to': u"orm['auth.User']"})
        },
        ...
        u'monitor.role': {
            ...
            'account': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['monitor.Account']", 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'role': ('django.db.models.fields.CharField', [], {'default': "'owner'", 'max_length': '512'}),
